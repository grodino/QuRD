...
# Evaluate the models 
python -u main.py $config accuracy --benchmark $benchmark --dataset $dataset

# Evaluate the distance between models
python main.py $config oracle-distance --benchmark $benchmark --dataset $dataset --split "test"
python main.py $config oracle-distance --benchmark $benchmark --dataset $dataset --split "train"